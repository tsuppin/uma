...
# --- 1. データの読み込みと統合 ---
file_list = [
    "hakodate_REAL_2022_full.csv", 
    "hakodate_REAL_2023_full.csv", 
    "hakodate_REAL_2024_full.csv", 
    "hakodate_REAL_2025_full.csv"
]
...
if not df_list:
    ...
    print(f"函館データ総件数 {len(df)} 件の学習を開始します...")
    model = lgb.train(
        params,
        train_data,
        num_boost_round=200
